...
(function(T, a) {
    ...
    function M(m, f) {
        ...
        for (var d in m) !m.hasOwnProperty(d) || "$" === d.charAt(0) && "$" === d.charAt(1) || (f[d] = m[d]);
        return f
    }
                ...
                function c(b, c) {
                    ...
                    r(c, function(c, f) {
                        ...
                        if (c && c.charAt && "@" === c.charAt(0)) {
                            ...
                            for (var k = k.split("."), h = 0,
                                    n = k.length; h < n && a.isDefined(e); h++) {
                                var g = k[h];
                                e = null !== e ? e[g] : void 0
                            }
                        } else e = c;
                ...
                r(z, function(b, a) {
                    ...
                    h[a] = function(e, k, J, y) {
                        ...
                        var E = this instanceof h,
                            ...
                            F = b.interceptor && b.interceptor.response ||
                            s,
                            ...
                            p = p.then(function(c) {
                                ...
                                if (e) {
                                    if (P(e) !== !!b.isArray) throw B("badcfg",
                                        a, b.isArray ? "array" : "object", P(e) ? "array" : "object", q.method, q.url);
